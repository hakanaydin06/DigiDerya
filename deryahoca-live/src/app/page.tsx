...
const SOCIAL_LINKS = [
    { Icon: YoutubeIcon, name: 'YouTube', url: 'https://www.youtube.com/@DeryaHocan', bg: 'from-red-600 to-red-700' },
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-2 mb-10 flex-wrap">
                            {SOCIAL_LINKS.map(({ Icon, name, url, bg }, idx) => (
                                ...
                                >
                                    <Icon />
                                    <span className="absolute -bottom-7 left-1/2 -translate-x-1/2 bg-black/80 text-white text-[10px] px-2 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10">
                                        {name}
                                    </span>
                                </a>
                            ))}
